                ...
                <div class="nav-collapse collapse">
                  <ul class="nav" id="mainNavigation">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="blog.blade.php">قالب بندی پیش فرض</a></li>
            ...
            <div class="row">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li><span class="icon-chevron-right"></span></li>
                        <li>
                            <a href="blog.blade.php">همه نوشته ها</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <section class="span8 blog">
                    ...
                    <article class="post format-standard sticky">
                        <div class="post-inner">
                            ...
                            <a href="blog-single.blade.php" class="btn btn-primary bold higher">ادامه مطلب</a>
                        </div>
                    </article>
                    ...
                    <article class="post format-image">
                        <div class="post-inner">
                            <a href="blog-single.blade.php"><img src="images/dummy/blog-posts/post-1.jpg" alt="featured image" width="1540" height="746" /></a>
                            <div class="post-title">
