                ...
                <div class="nav-collapse collapse">
                  <ul class="nav" id="mainNavigation">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="shop.blade.php">قالب بندی پیش فرض</a></li>
            ...
            <div class="row">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li><span class="icon-chevron-right"></span></li>
                        <li>
                            <a href="shop.blade.php">قالب بندی اصلی</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<a href="#" data-target="shred" data-type="brand" class="selectable detailed"><i class="box"></i> Shred</a>
                ...
                <section class="span9">
                    ...
                    <!--  = Products =  -->
                    <!--  ==========  -->
                    	     <div class="col col-lg-3 col-md-6 col-xs-12 products">
                	        <!--  ==========  -->
                            <!--  = Single Product =  -->
                            <!--  ==========  -->
                                 @foreach($products as $product )
                                         <div class="img">
                    	                    <img width="230" height="139" alt="" src="{{url('images/products/'. $product->product_img )  }}" />
                                             </div>
                                 <div class="product_detail" >
                                     <a href="{{url('product/' . $product->id) . '/' . $product->product_name}}">show</a>
                                     </div>
                                    @endforeach
                    	     <!-- /single product -->
