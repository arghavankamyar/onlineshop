...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <link href="stylesheets/oil-green.css" rel="stylesheet">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="index-oil-green.blade.php">پوسته سبز روغنی</a></li>
        ...
        <div class="fullwidthbanner">
            <ul>
                <li data-transition="premium-random" data-slotamount="3">
                    ...
                    <a href="features.blade.php" class="caption lfl btn btn-primary btn_theme"
                       data-x="120"
                       data-y="260"
                       data-speed="1000"
                       data-start="900"
                ...
                <li data-transition="premium-random" data-slotamount="3">
                    ...
                    <a href="icons.blade.php" class="caption lfl btn btn-primary btn_theme"
                       data-x="120"
                       data-y="260"
                       data-speed="1000"
                       data-start="900"
        ...
        <div class="row featured-items blocks-spacer">
            <div class="span12">
            	...
            	<div class="main-titles lined">
            	    <h2 class="title"><span class="light">مصحولات</span> ویژه</h2>
            	    <div class="arrows">
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 452</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 520</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
            	    ...
            	    <div class="slide">
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            <h4 class="title">$108</h4>
    	            	            <h5 class="no-margin">محصول ویژه 577</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 332</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 519</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
            ...
            <div class="row popup-products blocks-spacer">
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            ...
                            <h5 class="no-margin">محصول ویژه 498</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 318</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 462</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 199</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 287</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 135</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 385</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 415</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
	    	...
	    	<div class="row popup-products">
                ...
                <div class="span3">
                    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 263</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
                ...
                <div class="span3">
                    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 317</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
                ...
                <div class="span3">
                    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 229</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
