        ...
        <div class="row featured-items blocks-spacer">
            <div class="span12">
                ...
                <div class="main-titles lined">
                    <h2 class="title"><span class="light">پیشنهادهای مناسب فصل</span></h2>
                    <div class="arrows">
    ...
    <div class="boxed-area blocks-spacer">
        <div class="container">
            ...
            <div class="row">
                <div class="span12">
                    <div class="main-titles lined">
                        <h2 class="title"><span class="light">جدید ترین های عطر و ادکلن</span></h2>
                    </div>
                </div>
            </div> <!-- /title -->
    ...
    <div class="most-popular blocks-spacer">
        <div class="container">
            ...
            <div class="row">
                <div class="span12">
                    <div class="main-titles lined">
                        <h2 class="title"><span class="light">محبوب ترین محصولات ما</span></h2>
                    </div>
                </div>
            </div> <!-- /title -->
