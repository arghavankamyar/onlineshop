                ...
                <section class="span9">
                    ...
                    <div class="row popup-products">
                        <div id="isotopeContainer" class="isotope-container">
                            ...
                            <!--  = Single Product =  -->
                            <!--  ==========  -->
                    	    <div class= "span3" data-price="1567" data-popularity="2" data-size="xs|s|m|xl" data-color="pink" data-brand="adidas">
                    	        <div class="product" style="float: right;">
                    	            ...
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="470" height="379" alt="" src="{{url('images/products/'. $product->product_img )  }}" />
