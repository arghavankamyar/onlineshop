            ...
            <div class="span9">
                ...
                <div class="nav-collapse collapse">
                  <ul class="nav" id="mainNavigation">
                    ...
                    <li class="active"><a href="contact.blade.php">تماس با ما</a></li>
                  </ul>
            ...
            <div class="row">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="contact.blade.php">ارتباط با ما</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="span12">
                    <div class="title-area">
                        ...
                        <h1 class="inline"><span class="light">{{$content->title}} </span></h1>
                    </div>
                </div>
                ...
                <section class="span8 single single-page">
                    ...
                    <section class="contact-form-container">
                        @if(session()->has('delivery_message'))
                        ...
                        <form action="{{url('contact')}}" method="post" >
                            ...
                            @if($errors->has('subject'))
                                <div class="error">لطفا نام خود را وارد نمایید.</div>
                                @endif
                            ...
                            @if($errors->has('email'))
                                <div class="error">لطفا ایمیل خود را به صورت صحیح وارد نمایید.</div>
                            @endif
                            <input type="email" id="email" name="email" class="form-control" value="{{old('email')}}">
                            <label for="message_body" class="control-label">پیام *</label>
                            @if($errors->has('message_body'))
                                <div class="error">لطفا متن پیام خود را وارد نمایید.</div>
                            @endif
                            <textarea id="message_body" name="message_body" class="form-control" style="resize: none;width: 738px;height: 81px;"></textarea><br />
                            <button type="submit" value="submit" class="form-control btn btn-large btn-danger">ارسال پیام</button>
                        </form>
                        </div>
                    </section>
                ...
                <aside class="span4">
                    ...
                    <div class="sidebar-item widget_twitter">
                        <div class="underlined">
                            <h3><span class="light">اینستاگرام ما</span> </h3>
                        </div>
