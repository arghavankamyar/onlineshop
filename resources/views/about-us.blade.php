            ...
            <div class="span9">
                ...
                <div class="nav-collapse collapse">
                  <ul class="nav" id="mainNavigation">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle"> خانه <b class="caret"></b> </a>
                        <ul class="dropdown-menu">
                            <li class="dropdown">
                                <a href="#"><i class="icon-caret-left pull-right visible-desktop"></i> رنگ های پوسته</a>
                                <ul class="dropdown-menu">
                                    <li><a href="#">پوسته پیش فرض</a></li>
                    ...
                    <li class="active"><a href="about-us.blade.php">درباره ما</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="span12">
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">فروشگاه پریماورا</a>
                        </li>
                        <li><span class="icon-chevron-right"></span></li>
                        <li>
                            <a href="about-us.blade.php">درباره ما</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <aside class="span3">
                    <div class="sidebar-item">
                        ...
                        <div class="underlined">
                        	<h3><span class="light">اطلاعات تماس</span></h3>
                        </div>
                        ...
                        <div class="row">
                        	<div class="span3" id="spyMenu">
		                    	...
		                    	<ul class="nav nav-pills nav-stacked">
		                    	    <li class="label label-info about-us-info">تلفن تماس:</li>
                                    <li>{{$content->company_phone}}</li>
		                    	    <li class="label label-info about-us-info">نشانی ایمیل:</li>
                                    <li>{{$content->company_email}}</li>
		                    	    <li class="label label-info about-us-info">نشانی دفتر مرکزی:</li>
                ...
                <section class="span9">
                    ...
                    <div class="underlined push-down-20">
                        <h3><span class="light">{{$content->title}}</span></h3>
                    </div> <!-- /title -->
