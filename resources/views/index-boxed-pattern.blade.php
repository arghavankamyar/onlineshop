                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="index-boxed-pattern.blade.php">Boxed - با پس زمینه الگو</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <div class="slide">
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 259</h5>
    	            	        </div>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            <h4 class="title">$114</h4>
    	            	            <h5 class="no-margin">محصول ویژه 505</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 642</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
            	    ...
            	    <div class="slide">
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 678</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 608</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            <h4 class="title">$59</h4>
    	            	            <h5 class="no-margin">محصول ویژه 308</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
            ...
            <div class="row popup-products blocks-spacer">
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            ...
                            <h5 class="no-margin">محصول ویژه 179</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 230</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 93</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 151</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 299</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 254</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 144</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 322</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
	    	...
	    	<div class="row popup-products">
                ...
                <div class="span3">
                    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 392</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
                ...
                <div class="span3">
                    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 404</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
                ...
                <div class="span3">
                    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 366</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
