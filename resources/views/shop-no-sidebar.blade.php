...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    <meta charset="utf-8">
    <title>Webmarket HTML Template - All Products (without sidebar)</title>
                  ...
                  <ul class="nav" id="mainNavigation">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="shop-no-sidebar.blade.php">تمام صفحه</a></li>
                ...
                <div class="cart-container" id="cartContainer">
                    ...
                    <div class="open-panel">
                        ...
                        <div class="item-in-cart clearfix">
                            ...
                            <div class="desc">
                                <strong><a href="product.blade.php">کیف پول مردانهa></strong>
                                <span class="light-clr qty">
                                    تعداد : 1
                                    &nbsp;
                                    <a href="#" class="icon-remove-sign" title="Remove Item"></a>
        	...
        	<div class="row">
        		<div class="span12">
        		    <ul class="breadcrumb">
	                    ...
	                    <li>
	                        <a href="shop.blade.php">فروشگاه</a>
	                    </li>
	                    <li><span class="icon-chevron-right"></span></li>
	                    <li>
	                        <a href="shop-no-sidebar.blade.php">همه محصولات (بدون سایدبار)</a>
	                    </li>
	                </ul>
        		</div>
        	</div>
                ...
                <section class="span12">
                    ...
                    <div class="row popup-products">
                        <div id="isotopeContainer" class="isotope-container">
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--hats" data-price="1652" data-popularity="1" data-size="s|l" data-color="orange" data-brand="puma">
                    	        <div class="product">
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h5 class="no-margin isotope--title">Amet Neque Sed Duis</h5>
                    	            </div>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--bags" data-price="299" data-popularity="1" data-size="xs|s|l|xl" data-color="green|orange" data-brand="nike">
                    	        <div class="product">
                    	            ...
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="540" height="374" alt="" src="images/dummy/products/product-25.jpg" />
                    	                    <div class="img-overlay">
                    	                        <a class="btn more btn-primary" href="#">توضیحات بیشتر</a>
                    	                        <a class="btn buy btn-danger" href="#">اضافه به سبد خرید</a>
                    	                    </div>
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$299</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Sed Vulputate</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--swimwear" data-price="1649" data-popularity="4" data-size="xs|s|xl|xxl" data-color="red|orange" data-brand="puma">
                    	        <div class="product">
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h5 class="no-margin isotope--title">Consectetur Est Eros Sit Amet</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--polo-shirts" data-price="1645" data-popularity="1" data-size="xs|s|m|xl" data-color="green|purple" data-brand="adidas">
                    	        <div class="product">
                    	            ...
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="540" height="374" alt="" src="images/dummy/products/product-18.jpg" />
                    	                    <div class="img-overlay">
                    	                        <a class="btn more btn-primary" href="#">توضیحات بیشتر</a>
                    	                        <a class="btn buy btn-danger" href="#">اضافه به سبد خرید</a>
                    	                    </div>
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$1645</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Vel Sit Metus</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--blazers" data-price="1683" data-popularity="5" data-size="s|m|xl|xxl" data-color="blue" data-brand="nike">
                    	        <div class="product">
                    	             
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="540" height="374" alt="" src="images/dummy/products/product-28.jpg" />
                    	                    <div class="img-overlay">
                    	                        <a class="btn more btn-primary" href="#">توضیحات بیشتر</a>
                    	                        <a class="btn buy btn-danger" href="#">اضافه به سبد خرید</a>
                    	                    </div>
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$1683</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Sit Amet Consectetur Vivamus Eros</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--vests" data-price="308" data-popularity="5" data-size="s|m" data-color="red" data-brand="puma">
                    	        <div class="product">
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$308</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Metus Condimentum</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--swimwear" data-price="1247" data-popularity="4" data-size="s|m" data-color="pink" data-brand="shred">
                    	        <div class="product">
                    	             
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="540" height="374" alt="" src="images/dummy/products/product-4.jpg" />
                    	                    <div class="img-overlay">
                    	                        <a class="btn more btn-primary" href="#">توضیحات بیشتر</a>
                    	                        <a class="btn buy btn-danger" href="#">اضافه به سبد خرید</a>
                    	                    </div>
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$1247</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Vel Sed Dapibus</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--chinos" data-price="994" data-popularity="4" data-size="s|m|l|xl" data-color="blue|pink" data-brand="nike">
                    	        <div class="product">
                    	             
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="540" height="374" alt="" src="images/dummy/products/product-17.jpg" />
                    	                    <div class="img-overlay">
                    	                        <a class="btn more btn-primary" href="#">توضیحات بیشتر</a>
                    	                        <a class="btn buy btn-danger" href="#">اضافه به سبد خرید</a>
                    	                    </div>
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$994</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Adipiscing Tincidunt Ac Eros</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--bags" data-price="1542" data-popularity="3" data-size="s|xl" data-color="green" data-brand="naish">
                    	        <div class="product">
                    	             
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="540" height="374" alt="" src="images/dummy/products/product-11.jpg" />
                    	                    <div class="img-overlay">
                    	                        <a class="btn more btn-primary" href="#">توضیحات بیشتر</a>
                    	                        <a class="btn buy btn-danger" href="#">اضافه به سبد خرید</a>
                    	                    </div>
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title"><span class="striked">$1542</span> <span class="red-clr">$1387.8</span></h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Lorem Dolor Vulputate</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
                    	    ...
                    	    <div class="span3 filter--underwear" data-price="167" data-popularity="2" data-size="xs|s|l" data-color="blue|pink" data-brand="naish">
                    	        <div class="product">
                    	            ...
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="540" height="374" alt="" src="images/dummy/products/product-16.jpg" />
                    	                    <div class="img-overlay">
                    	                        <a class="btn more btn-primary" href="#">توضیحات بیشتر</a>
                    	                        <a class="btn buy btn-danger" href="#">اضافه به سبد خرید</a>
                    	                    </div>
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$167</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Sit Elit Feugiat Metus Condimentum</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--trousers" data-price="1609" data-popularity="4" data-size="xs|s" data-color="pink" data-brand="s-oliver">
                    	        <div class="product">
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$1609</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Consectetur Tincidunt Ac</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
							...
							<!--  = Single Product =  -->
							<!--  ==========  -->
                    	    <div class="span3 filter--bags" data-price="960" data-popularity="5" data-size="xs|l" data-color="red|green" data-brand="puma">
                    	        <div class="product">
                    	             
                    	            <div class="product-img">
                    	                <div class="picture">
                    	                    <img width="540" height="374" alt="" src="images/dummy/products/product-21.jpg" />
                    	                    <div class="img-overlay">
                    	                        <a class="btn more btn-primary" href="#">توضیحات بیشتر</a>
                    	                        <a class="btn buy btn-danger" href="#">اضافه به سبد خرید</a>
                    	                    </div>
                    	            ...
                    	            <div class="main-titles no-margin">
                    	                ...
                    	                <h4 class="title">$960</h4>
                    	                 
                    	                <h5 class="no-margin isotope--title">Consectetur Adipiscing Sed Duis Condimentum</h5>
                    	            </div>
                    	            <p class="center-align stars">
                    	                <span class="icon-star stars-clr"></span>
                    	                <span class="icon-star stars-clr"></span>
