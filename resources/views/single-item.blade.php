...
<head>
    ...
    <link rel="stylesheet" href="{{asset('stylesheets/rtl.css')}}">
    <!--  Google Fonts  -->
                            ...
                            <ul class="nav" id="mainNavigation">
                                ...
                                <li class="dropdown active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="product.blade.php">محصول تکی</a></li>
            ...
            <div class="row">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li><span class="icon-chevron-right"></span></li>
                        <li>
                            <a href="product.blade.php">تی شرت مردانه کلاه دار</a>
                        </li>
                    </ul>
                </div>
            </div>
