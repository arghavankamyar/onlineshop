                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="active"><a href="index-boxed-solid.blade.php">Boxed - با رنگ پس زمینه ثابت</a></li>
                    ...
                    <div class="slide">
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 568</h5>
    	            	        </div>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            <h4 class="title">$104</h4>
    	            	            <h5 class="no-margin">محصول ویژه 382</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 309</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 742</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 681</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin">محصول ویژه 569</h5>
    	            	        </div>
    	            	        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
    	            	        <p class="center-align stars">
                    	            <span class="icon-star stars-clr"></span>
            ...
            <div class="row popup-products blocks-spacer">
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            ...
                            <h5 class="no-margin">محصول ویژه 436</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 320</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 348</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 376</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 120</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 289</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
            	...
            	<div class="span3">
            	    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 111</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
	    	...
	    	<div class="row popup-products">
                ...
                <div class="span3">
                    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 266</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
                ...
                <div class="span3">
                    <div class="product">
                        ...
                        <div class="main-titles no-margin">
                            <h4 class="title">$32</h4>
                            <h5 class="no-margin">محصول ویژه 448</h5>
                        </div>
                        <p class="desc">توضیحاتی که در مورد محصول لازم است را در اینجا مینویسید</p>
                        <p class="center-align stars">
                            <span class="icon-star stars-clr"></span>
